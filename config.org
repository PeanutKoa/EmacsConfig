...
- [[#package-management-basic-keybinds-other-startup-stuff][Package Management, Basic Keybinds, Other Startup Stuff]]
  ...
  - [[#keybindings][Keybindings]]
    ...
    - [[#meow-3][Meow :3]]
    - [[#undo-tree][Undo Tree]]
    - [[#parentheses-functions][Parentheses Functions]]
    - [[#generic-keybinds][Generic Keybinds]]
...
- [[#org-mode][Org Mode]]
  - [[#beautifying-1][Beautifying]]
    ...
    - [[#header-variable-size][Header Variable Size]]
...
- [[#lsp][LSP]]
  - [[#lsp-mode][LSP-Mode]]
    ...
    - [[#lsp-mode-integrations][LSP-Mode Integrations]]
...
- [[#keybindings-leader][Keybindings Leader]]
  ...
  - [[#actions][Actions]]
    ...
    - [[#magit-m][Magit (m)]]
    - [[#org-o][Org (o)]]
    - [[#parenthesespuni-p][Parentheses/Puni (p)]]
